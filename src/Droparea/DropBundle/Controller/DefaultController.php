...
class DefaultController extends Controller
{
    ...
    public function ordersAction()
    {
        ...
        $cityObject = $this->getDoctrine()->getRepository(PostAddress::class)->find(1);
...
//        echo "</pre>";die;
        ...
        foreach ($citiesArray['data'] as $city) {
            ...
            $staticSitiesFull[$i]['a'] = $this->getArea($lisOfAreas, $city['Area']);
            $i++;
        }
//        echo "<pre>";
...
//        echo "</pre>";die;
    ...
    public function getArea($lisOfAreas, $city)
    {
