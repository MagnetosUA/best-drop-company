 ...
 */
class Version20190327081629 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, images LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', name VARCHAR(255) NOT NULL, cost INT NOT NULL, recomendedCost INT NOT NULL, new TINYINT(1) NOT NULL, top TINYINT(1) NOT NULL, description VARCHAR(3000) NOT NULL, provider VARCHAR(50) NOT NULL, orders VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
